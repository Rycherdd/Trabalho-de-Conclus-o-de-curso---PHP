...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="descVolunt.css">  
        ...
        <div id="img">
           ...
           <div class="media-body">
                ...
                <div id="cad">
                  ...
                  <center><h1 style="margin-top: 50px;">Agendamento no SquadIF</h1></center>
...
<a class="btn btn-primary" type="button" value="Voltar" href="https://squadif.000webhostapp.com/descricao_voluntario.php">Voltar</a>
          <br>
        </div>
      </div>
    </div>
