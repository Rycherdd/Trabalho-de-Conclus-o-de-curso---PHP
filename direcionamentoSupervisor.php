...
<div id="box">
<a href="supervisor.php" type="button" class="btn btn-outline-success">Solicitações para supervisão</a>
<a href= "descricaoSupervisor.php" type="button" class="btn btn-outline-success">Visualizar histórico de agendamentos</a>
